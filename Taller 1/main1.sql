...
CREATE OR REPLACE VIEW LOPEZ_JUAN_6 AS
    SELECT
        TABLA1.*,
        TABLA2.TABLA2_DATO1,
        TABLA2.TABLA2_DATO2
    FROM
        TABLA1
        ,TABLA2
        WHERE TABLA1.ID = TABLA2.ID_TABLA1
    WHERE
...
-- However this can be fixed using "DEFAULT"
ALTER TABLE TABLA2 ADD TABLA2_DATO3 NUMERIC(10, 2) NOT NULL DEFAULT 10.12;
...
SELECT 'GEN1' AS GEN, COUNT(*) AS TOTAL_POKEMON FROM JLEON.POKEDEX_2 WHERE GENERATION = 1
    UNION
SELECT 'GEN2' AS GEN, COUNT(*) AS TOTAL_POKEMON FROM JLEON.POKEDEX_2 WHERE GENERATION = 2
    UNION
SELECT 'GEN3' AS GEN, COUNT(*) AS TOTAL_POKEMON FROM JLEON.POKEDEX_2 WHERE GENERATION = 3
    UNION
SELECT 'GEN4' AS GEN, COUNT(*) AS TOTAL_POKEMON FROM JLEON.POKEDEX_2 WHERE GENERATION = 4
    UNION
SELECT 'GEN5' AS GEN, COUNT(*) AS TOTAL_POKEMON FROM JLEON.POKEDEX_2 WHERE GENERATION = 5
    UNION
SELECT 'GEN6' AS GEN, COUNT(*) AS TOTAL_POKEMON FROM JLEON.POKEDEX_2 WHERE GENERATION = 6
    UNION
SELECT 'GEN7' AS GEN, COUNT(*) AS TOTAL_POKEMON FROM JLEON.POKEDEX_2 WHERE GENERATION = 7
    UNION
SELECT 'GEN8' AS GEN, COUNT(*) AS TOTAL_POKEMON FROM JLEON.POKEDEX_2 WHERE GENERATION = 8;


CREATE OR REPLACE VIEW LOPEZ_JUAN_17 AS
    SELECT 'GEN1' AS GEN, COUNT(*) AS TOTAL_POKEMON FROM JLEON.POKEDEX_2 WHERE GENERATION = 1
    UNION
SELECT 'GEN2' AS GEN, COUNT(*) AS TOTAL_POKEMON FROM JLEON.POKEDEX_2 WHERE GENERATION = 2
    UNION
...
CREATE OR REPLACE VIEW LOPEZ_JUAN_20 AS
   SELECT
    DISTINCT TYPE_1
FROM
    JLEON.POKEDEX_2
...
FROM
    JLEON.POKEDEX, JLEON.POKEMON_ABILITIES, JLEON.ABILITY_NAMES, JLEON.LANGUAJE
    
    WHERE JLEON.POKEDEX.ID_P = JLEON.POKEMON_ABILITIES.POKEMON_ID and  JLEON.POKEMON_ABILITIES.ABILITY_ID = JLEON.ABILITY_NAMES.ABILITY_ID
    and JLEON.ABILITY_NAMES.LOCAL_LANGUAGE_ID = JLEON.LANGUAJE.ID
and
    JLEON.LANGUAJE.ISO639 = 'es';

CREATE OR REPLACE VIEW LOPEZ_JUAN_23 AS
  SELECT
    JLEON.POKEDEX.ID_P AS POKEMON_ID,
    JLEON.POKEDEX.IDENTIFIER_P AS POKEMON_NAME,
    JLEON.ABILITY_NAMES.NAME_A AS ABILITY_NAME_ES
...
FROM
    JLEON.POKEDEX
    ,JLEON.POKEDEX_2
    where UPPER(JLEON.POKEDEX.IDENTIFIER_P) = UPPER(JLEON.POKEDEX_2.NAME)
...
CREATE OR REPLACE VIEW LOPEZ_JUAN_26 AS
    SELECT
        JLEON.POKEDEX_2.POKEDEX_NUMBER,
        JLEON.POKEDEX_2.NAME,
        JLEON.POKEDEX.SPECIES_ID,
...
GRANT SELECT ON IS324304.LOPEZ_JUAN_13 TO JLEON;
GRANT SELECT ON IS324304.LOPEZ_JUAN_14 TO JLEON;
GRANT SELECT ON IS324304.LOPEZ_JUAN_15 TO JLEON;
GRANT SELECT ON IS324304.LOPEZ_JUAN_16 TO JLEON;
GRANT SELECT ON IS324304.LOPEZ_JUAN_17 TO JLEON;
GRANT SELECT ON IS324304.LOPEZ_JUAN_18 TO JLEON;
GRANT SELECT ON IS324304.LOPEZ_JUAN_19 TO JLEON;
GRANT SELECT ON IS324304.LOPEZ_JUAN_20 TO JLEON;
GRANT SELECT ON IS324304.LOPEZ_JUAN_23 TO JLEON;
GRANT SELECT ON IS324304.LOPEZ_JUAN_24 TO JLEON;
GRANT SELECT ON IS324304.LOPEZ_JUAN_25 TO JLEON;
GRANT SELECT ON IS324304.LOPEZ_JUAN_26 TO JLEON;

--The tables themselves have errors
GRANT SELECT ON IS324304.LOPEZ_JUAN_5 TO JLEON;
GRANT SELECT ON IS324304.LOPEZ_JUAN_6 TO JLEON;
